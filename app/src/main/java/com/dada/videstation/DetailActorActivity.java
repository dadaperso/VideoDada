...
import com.dada.videstation.adapter.ActorFilmAdapter;
import com.dada.videstation.adapter.ActorTvShowAdapter;
...
public class DetailActorActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_film) {
            Intent intent = new Intent(DetailActorActivity.this, FilmActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_serie) {
            Intent intent = new Intent(DetailActorActivity.this, TvShowActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_acteur) {
            Intent intent = new Intent(DetailActorActivity.this, ActorActivity.class);
            startActivity(intent);
        }
